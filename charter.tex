...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en el desarrollo de un dispositivo que posibilite la adaptación e integración de equipos comerciales a una red domótica orientada al control y monitoreo de sistemas energéticos en motorhomes. El trabajo tendrá un presupuesto preliminar estimado de \textcolor{red}{600} horas y un costo estimado de \textcolor{red}{\$ XXX}, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
...
\begin{enumerate}
	\item Requerimientos en el dispositivo:
		\begin{enumerate}
			...
			\item La frecuencia de actualización de datos debe ser de alrededor de cada veinte segundos.			
		\end{enumerate}
	\item Requerimientos en la aplicación:
		\begin{enumerate}
			...
			\item Puede incluir la funcionalidad logueo de usuario para acceso a los controles del sistema.
		\end{enumerate}
...
\begin{enumerate}
	...
	\item Como instalador, quiero que el dispositivo se alimente desde la red física existente (+12, GND, CAN H, CAN L) para facilitar la integración en el motorhome.
		\begin{itemize}
			...
			\item Story point: 8.
	\end{itemize}
	\item Como técnico de Enertik, quiero que el dispositivo se comunique con el PRC10 mediante CAN para poder integrar la red de domótica con el nuevo sistema.
		\begin{itemize}
...
\item Análisis inicial (30 h)
	\begin{enumerate}
	\item Revisión de documentación de microcontrolador ESP32 (5 h)
	\item Revisión de documentación de Victron Energy y Modbus TCP (20 h)
	\item Preparación de entorno de desarrollo IDE (5 h)
	\end{enumerate}
\item Desarrollo de hardware (233 h)
	\begin{enumerate}
	\item Configuración periféricos de ESP32: pines, timers, puertos, RTOS (10 h)
	\item Implementación de Wi-FI como Acess Point: configuración y manejo de conexión (10 h)
	\item Desarrollo de comunicación con PRC10
		\begin{enumerate}
		\item Protocolo CAN: implementación con MCP2551 (10 h)
		\item Desarrollo de módulo transceiver (10 h)
	...
	\item Desarrollo de comunicación con Cerbo GX
		\begin{enumerate}
		\item Desarrollo de librería con la información de todos los dispositivos de Victron Energy (25 h)
		\item Modbus TCP: implementación por Wi-Fi (30 h)
		\item Modbus TCP: implementación por Ethernet con W5100 (30 h)		
		\item Incorporación de los comandos y funciones para operar con los registros por Modbus (30 h)
		\item Análisis y comporativa de implementación Wi-Fi y Ethernet (8 h)
		\item Ensayos de comunicación entre ESP32 y Cerbo GX (20 h)
		\end{enumerate}		
	\end{enumerate}
\item Desarrollo de aplicación (220 h)
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item Conversión de formato y carga de la aplicación al ESP32 (15 h)
			\item Ensayos con distintos navegadores y dispositivos (15 h)
		\end{enumerate}
		\item Desarrollo de aplicación nativa para Android
		\begin{enumerate}
			\item Creación y configuración de proyecto en Angular (10 h)
			\item Desarrollo de componentes y vistas (HTML - CSS - Javascript) (30 h)
			\item Manejo de peticiones y funciones para comunicación con ESP32 por websocket (15 h)
...
\item Redacción de informe final para maestría (70 h)
	\begin{enumerate}
		\item Redacción de informe de avance (10 h)
		\item Redacción de informe final del proyecto (40 h)
		\item Elaboración de presentación (20 h)
	\end{enumerate}
\end{enumerate}
