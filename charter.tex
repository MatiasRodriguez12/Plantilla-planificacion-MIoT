...
Esta tendencia genera la necesidad de desarrollar un dispositivo que permita integrar los equipos provistos por Victron Energy con la red de domótica desarrollada por Enertik.

La figura \ref{fig:esquema} muestra un diagrama en bloques que ilustra cómo debe establecerse la comunicación entre ambos sistemas. Para ello, es necesario implementar un vínculo entre los dispositivos PRC10 y Cerbo GX.
...
Cliente       & \clientename  		  &Enertik Argentina	& Director Enertik    \\ \hline
Responsable   & \authorname     		  & Enertik - FIUBA        	& Alumno 	\\ \hline
